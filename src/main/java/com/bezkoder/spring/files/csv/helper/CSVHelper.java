...
public class CSVHelper {
  ...
  static String[] HEADERs = { "OMC:UPW_I","Short Name","OMC_Name","CD_DN","NE_RELEASE","NE_STATE","KPI","DATE" };
    ...
    try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
      ...
      for (CSVRecord csvRecord : csvRecords) {
        ...
        Tutorial tutorial = new Tutorial(
                new Random().nextLong(),
                csvRecord.get("OMC:UPW_I"),
                csvRecord.get("Short Name"),
                csvRecord.get("OMC_Name"),
                csvRecord.get("CD_DN"),
                csvRecord.get("NE_RELEASE"),
                csvRecord.get("NE_STATE"),
                csvRecord.get("KPI"),
                csvRecord.get("DATE")
        );
